...
const neonButtonVariants = cva(
    "relative group border text-foreground mx-auto text-center rounded-full transition-all duration-200",
    {
        variants: {
            variant: {
                default: "bg-accent/5 hover:bg-accent/0 border-accent/20",
                solid: "bg-accent hover:bg-accent/90 text-accent-foreground border-transparent hover:border-foreground/50",
                ghost: "border-transparent bg-transparent hover:border-muted-foreground/30 hover:bg-foreground/10",
                destructive: "bg-destructive/5 hover:bg-destructive/0 border-destructive/20",
                secondary: "bg-secondary hover:bg-secondary/80 border-border/20",
            },
            size: {
                default: "px-7 py-1.5",
