...
const SYSTEMS = [
  ...
  { id: "analisador-criativos", name: "Analisador de Criativos", emoji: "🔬" },
  { id: "zap-spy", name: "Zap Spy", emoji: "🔍" },
  { id: "tag-whats", name: "Tag Whats", emoji: "🏷️" },
  { id: "extensao-ads", name: "Extensão Ads WhatsApp", emoji: "🧩" },
  { id: "video-downloader", name: "Download Vídeos TikTok", emoji: "📹" },
  { id: "maturador", name: "Maturador de WhatsApp", emoji: "🔥" },
  { id: "save-whatsapp", name: "Save WhatsApp", emoji: "💾" },
