...
import { 
  ...
  RotateCcw, Smartphone, Hash, Bell
} from "lucide-react";
...
export default function NotifyAdminAddNumber() {
  useActivityTracker("page_visit", "Notificar Admin - Adicionar Número");
      ...
      <div className="min-h-screen bg-background p-4 md:p-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="flex items-center gap-4 mb-6">
            <Button variant="ghost" size="icon" onClick={() => navigate("/inbox/notify-admin")}>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Adicione ou gerencie seus números do WhatsApp para notificações
                </p>
              </div>
            </div>
          </div>
